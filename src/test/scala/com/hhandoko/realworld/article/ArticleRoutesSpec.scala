...
//
//    ArticleRoutes[IO](new FakeArticleRepository(articles))
...
//    val getArticles = Request[IO](Method.GET, uri"/api/articles")
//
//    ArticleRoutes[IO](new FakeArticleRepository(Vector.empty))
//      .orNotFound(getArticles)
//      .unsafeRunSync()
//  }
//
...
//    )
//
//  class FakeArticleRepository(records: Vector[Article]) extends ArticleRepository[IO] {
//    override def find(limit: Option[Int], offset: Option[Int]): IO[Vector[Article]] =
//      IO.pure(records)
//  }
//
//}
